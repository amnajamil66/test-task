import { panelSparklesCollage, panelSparklesSingle, type PanelSparkle } from "@/lib/showcase-panel-sparkles";
...
function SparkleShape({ x, y, size, opacity = 0.7 }: PanelSparkle) {
  const r = size / 2;
  return (
    <polygon points={pentagonPoints(x, y, r)} fill="#ECEDEE" opacity={opacity} />
  );
}
